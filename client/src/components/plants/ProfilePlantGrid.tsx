...
export default function ProfilePlantGrid({ plants, showAddButton = false }: ProfilePlantGridProps) {
    ...
    return (
      <div className="p-4 text-center">
        <p className="text-lg text-gray-500 dark:text-gray-400">
          No plants available to display.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 italic mb-2 truncate">{plant.type || "Unknown type"}</p>
        ...
        <div className="mt-auto space-y-1">
          ...
          <div className="flex items-center text-xs">
            ...
            <span className="text-gray-600 dark:text-gray-300">
              {plant.nextWatering ? formatRelativeDate(new Date(plant.nextWatering)) : 'Not set'}
            </span>
          </div>
