...
export function CareTaskSummary({ userId }: CareSummaryProps) {
  ...
  if (isLoading) {
    return (
      <Card className="bg-white rounded-lg shadow-sm p-4 mb-6">
        <h3 className="font-medium mb-3">Today's Plant Care</h3>
        <div className="flex space-x-3">
          <div className="flex flex-col items-center bg-blue-50 p-3 rounded-lg flex-1 animate-pulse">
            <div className="h-6 w-6 bg-blue-200 rounded-full mb-1"></div>
  ...
  return (
    <Card className="bg-white rounded-lg shadow-sm p-4 mb-6">
      <h3 className="font-medium mb-3">Today's Plant Care</h3>
      <div className="flex space-x-3">
        <div className="flex flex-col items-center bg-blue-50 p-3 rounded-lg flex-1">
        ...
        <div className="flex flex-col items-center bg-green-50 p-3 rounded-lg flex-1">
          ...
          <span className="text-xs text-neutral-dark opacity-70">Fertilize</span>
          <span className="font-medium text-sm">{fertilizerCount} plant{fertilizerCount !== 1 ? 's' : ''}</span>
        </div>
      </div>
    </Card>
  );
