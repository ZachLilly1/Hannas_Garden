...
export const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M11 20A7 7 0 0 1 4 13c0-3.4 2.4-6.5 5.6-7.6a1 1 0 0 1 1.2.4c.5.7 1 1.5 1.3 2.2a1 1 0 0 1-.2 1.2c-1 .8-1.5 2-1.3 3.1a3.5 3.5 0 0 0 3.5 2.7h1.8a1 1 0 0 1 .9 1.5 7 7 0 0 1-5.8 3.5z" />
    <path d="M13.8 15.5A7 7 0 0 0 20 8c0-3.4-2.4-6.5-5.6-7.6a1 1 0 0 0-1.2.4c-.5.7-1 1.5-1.3 2.2a1 1 0 0 0 .2 1.2c1 .8 1.5 2 1.3 3.1a3.5 3.5 0 0 1-3.5 2.7H8.1a1 1 0 0 0-.9 1.5c1 1.7 2.7 2.8 4.6 3" />
  </svg>
);
...
export const SeedlingIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
